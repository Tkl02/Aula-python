...
def joguempo():
    while True:
        ...
        user = input(
            "select your option: pedra, paper or scissors. (press X for endgame)"
        )
...
def play_jogempo():
    ...
    victory_rules = {"rock": "scissors", "paper": "rock", "scissors": "paper"}
    ...
    while True:
        ...
        user = (
            input(f"Select you play ({', '.join(options)}) or press X for endgame: ")
            .lower()
            .strip()
        )
